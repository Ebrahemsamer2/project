<div class='sidebar'>
    <ul class="list-unstyled">
        ...
        <li><a href="comments.php" class="<?php echo $comments; ?>"><i class='fa fa-comments-o'></i> Comments</a></li>
        ...
        <li><a href="setting.php" class="<?php echo $setting; ?>"><i class='fa fa-gear'></i> Settings</a></li>
