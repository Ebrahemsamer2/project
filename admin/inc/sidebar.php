<div class='sidebar'>
    <ul class="list-unstyled">
        <li><a href="index.php" class="<?php echo $dashboard; ?>"><i class='fa fa-tachometer'></i> Dashboard</a></li>
        <li><a href="posts.php" class="<?php echo $posts; ?>"><i class='fa fa-pencil'></i> Posts</a></li>
        ...
        <?php if(get_post_comments(0) !== 0) {
            echo '<span class="badge badge-success">' . get_post_comments(0). '</span>';
        } ?>
        </a></li>
        <li><a href="admins.php" class="<?php echo $admins; ?>"><i class='fa fa-user-secret'></i> Admins</a></li>
        <li><a href="admins.php" class="<?php echo $users; ?>"><i class='fa fa-users'></i> Users</a></li>
